...
const Announcements = () => {
  ...
  const handleCreate = async () => {
    ...
    try {
      ...
      setMsg({ type: 'success', text: 'Announcement sent to all barbers!' });
      fetchAnnouncements();
    } catch (err) {
  ...
  return (
    <div className="admin-page">
      <div className="container">
        ...
        <p className="page-subtitle">Send notices to all barbers</p>
        ...
        <div className="card" style={{ marginBottom: 24 }}>
          ...
          <button
            ...
            disabled={submitting}
          >
            {submitting ? 'Sending...' : '📢 Send to All Barbers'}
          </button>
        </div>

        {/* Announcements List */}
        <h3 style={{ color: 'var(--text-secondary)', marginBottom: 12, fontSize: 14, textTransform: 'uppercase', letterSpacing: 1 }}>
